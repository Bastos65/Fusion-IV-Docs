...
<table>
<tr><th>Nom de la Couleur</th><th>Code Hex</th><th>Aperçu</th></tr>
...
<tr><td colspan="3"><strong>Couleurs Personnalisées</strong></td></tr>
<tr><td>Custom Color 1</td><td colspan="2">Défini par l'utilisateur via code hex</td></tr>
<tr><td>Custom Color 2</td><td colspan="2">Défini par l'utilisateur via code hex</td></tr>
<tr><td>Custom Color 3</td><td colspan="2">Défini par l'utilisateur via code hex</td></tr>
</table>
...
2. S'assurer que le téléphone est connecté
3. Pour OpenWeatherMap : vérifier la clé API
4. Attendre quelques minutes après l'installation

#### Le cadran consomme trop de batterie

**Solutions** :
- Réduire le taux de rafraîchissement (Low ou Medium)
- Activer Screen Saver Delay
- Masquer les secondes ou utiliser le mode "Normal"
- Réduire le nombre de champs de données actifs

#### Les données ne se mettent pas à jour

**Solutions** :
- Augmenter le taux de rafraîchissement
- Vérifier les permissions du cadran
- Redémarrer la montre

#### Certaines données affichent "---" ou sont vides

**Cause** : Données non disponibles sur votre modèle de montre ou capteur non présent

**Solution** : Remplacer par un autre type de données compatible

### Debug

Le type de données **Debug Data** permet d'afficher des informations de diagnostic :
